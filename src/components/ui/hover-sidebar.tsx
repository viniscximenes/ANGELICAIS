...
export const DesktopSidebar = ({
  ...
  return (
    <motion.div
      className={cn(
        // bg-sidebar (token --sidebar): no dark mode é EXATAMENTE o mesmo
        // valor de --card (StyledCard/outros cards do site), confirmado em
        // globals.css. No light mode é o mesmo cinza já usado pra separar
        // a sidebar principal do dashboard da área de conteúdo — nem
